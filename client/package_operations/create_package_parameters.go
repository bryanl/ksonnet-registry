...
// WithNamespace adds the namespace to the create package params
func (o *CreatePackageParams) WithNamespace(namespace string) *CreatePackageParams {
	o.SetNamespace(namespace)
	return o
}

// SetNamespace adds the namespace to the create package params
func (o *CreatePackageParams) SetNamespace(namespace string) {
	o.Namespace = namespace
}

// WithPackage adds the packageVar to the create package params
func (o *CreatePackageParams) WithPackage(packageVar string) *CreatePackageParams {
	o.SetPackage(packageVar)
	return o
}

// SetPackage adds the package to the create package params
func (o *CreatePackageParams) SetPackage(packageVar string) {
